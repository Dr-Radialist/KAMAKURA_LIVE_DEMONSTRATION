...
$stmt = $pdo->prepare( "SELECT * FROM `session_tbls2019` WHERE `class` = 'tri' AND `sessionNo` >= '0' AND `year` = '" . $this_year . "' ORDER BY `sessionNo` ASC;" );
$flag = $stmt->execute();
...
<div class="container">
  <div class="row">
    <div class="container" id="day1">
      <h1 class="text-center text-danger">KAMAKURA TRI (12/14 SAT) <span style="color:red; font-weight:bold; font-size:small;">&nbsp;&nbsp;最終更新日時:
        <?= $latest ?>
        &nbsp;&nbsp;<a class="btn btn-lg btn-danger" href="../../planner_only/index-mod.php">Top Pageに戻る</a> </span></h1>
      <div class="row">
        <?php
        ...
        <div class="panel-group border-thick">
          <form method="post" action="../2019planning/db_entry/tri/tri01n.php">
            <button type="submit" class="subsession_button" name="sessionNo" value="<?=$sessionNo; ?>" 
            </button>
            Modify
            </button>
          </form>
          ...
          <div class="panel-heading">
            <ul class="list-inline">
              <li> <a data-toggle="collapse" href="#<?= 'collapse'.$sessionNo ?>">
                <button type="submit" class="button-detail" >詳細</button>
                </a> </li>
              <li class="bold18">
    ...
    <hr>
    <div class="container" id="day1">
      <h1 class="text-center text-danger">KAMAKURA TRI (12/15 SUN)</h1>
      <span style="color:red; font-weight:bold; font-size:small;">&nbsp;&nbsp;最終更新日時:
      <?= $latest ?>
      <a href="../../planner_only/index-mod.php">
      <button class="btn btn-sm btn-danger">Top Pageに戻る</button>
      </a> </span>
      <div class="row">
        <?php
