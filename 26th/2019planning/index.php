...
<body>
				...
				<ul class="nav nav-pills">
					<li class="dropdown"> <a href="#" class="dropdown-toggle li-white" data-toggle="dropdown" role="button" aria-expanded="false">Faculty Role割当<b class="caret"></b></a>
						<ul class="dropdown-menu" role="menu">
							<li role="presentation"><a href="../2017planning/index2017tri_mod-n.php">TRIライブRole割当</a>
							</li>
							<li role="presentation"><a href="../2017planning/index2017evt_mod-n.php">インタベ座学Role割当</a>
							</li>
							<li role="presentation"><a href="../2017planning/index2017come_mod-n.php">コメディカル・セッションRole割当</a>
							</li>
						</ul>
					</li>
					<li class="dropdown"> <a href="#" class="dropdown-toggle li-white" data-toggle="dropdown">管理者のコマンド<b class="caret"></b></a>
						<ul class="dropdown-menu">
							...
							<li><a href="../2017planning/dr_registration.php">Faculty追加・修正</a>
							</li>
							<li><a href="../2017planning/duplicated_roles.php">Faculty役割時間帯重複検出</a>
							</li>
						</ul>
					</li>
					<li class="dropdown"> <a href="#" class="dropdown-toggle li-white" data-toggle="dropdown">Faculty種別での検索<b class="caret"></b></a>
						<ul class="dropdown-menu">
							<li><a href="../2017planning/no_role_assigned.php?member_kind=1">NPO社員</a>
							</li>
							<li><a href="../2017planning/no_role_assigned.php?member_kind=1">Role割当数 = 1</a>
							</li>
							<li><a href="../2017planning/no_role_assigned.php?member_kind=2">Role割当数 = 2</a>
							</li>
							<li><a href="../2017planning/no_role_assigned.php?member_kind=3">Role割当数 = 3</a>
							</li>
							<li><a href="../2017planning/no_role_assigned.php?member_kind=4">Role割当数 = 4</a>
							</li>
						</ul>
					</li>
				</ul>
    ...
    <?= $latest ?>
			...
			<div class="row">
				<div class="col-lg-12"> <a class="btn btn-success" role="button" href="../2017planning/dr_registration.php">Faculty追加・修正</a> <a class="btn btn-danger" role="button" href="../2017planning/index2017tri_mod-n.php">TRIセッション修正</a> <a class="btn btn-warning" role="button" href="../2017planning/index2017evt_mod-n.php">インタベ座学修正</a> <a class="btn btn-primary" role="button" href="../2017planning/index2017come_mod-n.php">Comeセッション修正</a>
				</div>
	...
	<script src="../2017planning/24th/index2017.js"></script>
</body>
