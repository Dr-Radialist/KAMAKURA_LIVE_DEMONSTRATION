...
<body>
	<div class="container">
		<div class="row col-md-12 text-center">
			<h3 class="text-center text-danger">Checking for New Faculty Registration</h3>
			<span class="red_bold_sm">Last Updated:&nbsp;<?= $latest; ?></span>
			<div class="col-md-12">
				<div class="form-group">
					<form id="searchform" method="post">
						<label for="search_term">検索する医師/コメディカルのアルファベット姓を入力して下さい</label>
						<input type="text" class="form-control" id="search_term" name="search_term" placeholder="検索する医師/コメディカルのアルファベット姓を入力して下さい"/>
						<button></button>
