...
<div class="container">
  ...
  <div class="container">
    <div class="row">
      <form name="doctor" method="post" action="../../../2019planning/db_entry/doctor_registration/dr04new.php">
    ...
    <div><br><br></div>
    <form method="post" action="../../../2019planning/db_entry/doctor_registration/dr01new.php">
      <input type="hidden" name="id" value="<?= $_SESSION['id']; ?>" />
