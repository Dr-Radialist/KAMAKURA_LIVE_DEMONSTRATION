			...
			<div class="col-md-12">
				<div class="form-group">
					<form id="searchform" method="post">
						<label for="search_term">新たに登録する医師/コメディカルのメルアドを入力して下さい</label>
						<input type="text" class="form-control" id="search_term" name="search_term" placeholder="新たに登録する方のメルアドを入力して下さい (重複登録チェックのためです)"/>
						<button></button>
