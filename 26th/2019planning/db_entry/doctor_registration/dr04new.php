<?php
	...
	// 注意: 不要なspaceを挿入すると' $db_host'のようにみなされ、エラーとなる
		...
		$stmt = $pdo->prepare("INSERT INTO `doctor_tbls` (`english_sirname`,  `english_firstname`, `email`, `phone`, `is_male`, `kana_sirname`, `kana_firstname`, `kanji_sirname`, `kanji_firstname`, `hp_name_english`, `hp_name_japanese`, `hp_place_english`, `hp_place_japanese`, `member_kind`, `sponsor`, `changed`, `nation`, `on2019`) VALUES (:english_sirname, :english_firstname, :email, :phone, :is_male, :kana_sirname, :kana_firstname, :kanji_sirname, :kanji_firstname, :hp_name_english, :hp_name_japanese, :hp_place_english, :hp_place_japanese,  :member_kind,  :sponsor, :changed, :nation, :on2019);");
