...
<body>
	<div class="container">
		<div class="row">
			<div class="panel panel-danger">
				<div class="panel-heading">
					<ul class="list-inline">
						...
						<li><span style="font-weight: bold; font-size: 20px;">&nbsp;&nbsp;コメディカル・セッション 12/15 (SUN) @ 日石ホール</span>
						</li>
					</ul>
				</div>
			</div>
			...
			<div class="panel-heading">
				<ul class="list-inline">
					<li>
						<form method="post" action="../2019planning/db_entry/comedical_sessions/comedical01n.php">
							<button type="submit" class="detail" name="sessionNo" value="<?= $sessionNo; ?>">修正</button>
						</form>
					</li>
					<li>
						<button class="btn btn-danger btn-sm" onClick="location.href = '../../planner_only/index-mod.php'">Top Pageに戻る</button>
					</li>
					<li>
		...
		<?php
		for ( $sessionNo = 7; $sessionNo < 9; $sessionNo++ ) {
			?>
		<?php
		if ( mb_strpos( $rows[ $sessionNo ][ 'sessionTitle' ], "裏ライブ", 0, "UTF-8" ) !== false ) {
	...
	<?php
	for ( $sessionNo = 10; $sessionNo < 12; $sessionNo++ ) {
		?>
	<?php
	if ( mb_strpos( $rows[ $sessionNo ][ 'sessionTitle' ], "裏ライブ", 0, "UTF-8" ) !== false ) {
		echo '<div class="panel panel-success">';
