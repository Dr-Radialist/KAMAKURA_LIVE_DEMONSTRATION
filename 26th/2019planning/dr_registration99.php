...
foreach ( $rows as $row ) {
  ...
  $data .= '<input type="submit" value="' . '修正-' . $i . '" class="btn-sm" />';
  $data .= '</form></td>';
  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="small">
        ...
        <form method="post" action="../2019planning/db_entry/doctor_registration/dr00new.php">
          <button type="submit" class="btn btn-success">医師/コメディカル新規登録・修正</button>
        </form>
        <br>
