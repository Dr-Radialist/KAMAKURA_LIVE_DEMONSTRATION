...
foreach ( $rows as $row ) {
	/*
		  ...
		  */
	$data .= '<tr><td><button class="btn btn-danger" onClick="location.href=\'../../planner_only/index-mod.php\'"><span class="glyphicon glyphicon-fast-backward"></span></button></td>';
...
<body>
  ...
  <?= $latest ?>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="small">
					<button type="submit" class="btn btn-danger" onClick="location.href='../../planner_only/index-mod.php'"><span class="glyphicon glyphicon-fast-backward"></span>Top Pageに戻る</button>
					<form method="post" action="../2018planning/db_entry/doctor_registration/dr00new.php">
						<button type="submit" class="btn btn-success">新規Faculty登録</button>
					</form>
					<br>
					<table class="table table-striped">
						<thead>
							<tr>
								...
								<th class="smf">修正</th>
								<th class="smf"><button type="button" class="red_back" name="name" id="name" value="ASC" style="width:20px;text-align: center;"><span class="glyphicon glyphicon-resize-vertical"></span></button>
								</th>
								<th class="smf"><button type="button" class="red_back" name="kana_name" id="kana_name" value="ASC" style="width:20px;text-align: center;"><span class="glyphicon glyphicon-resize-vertical"></span></button>
								</th>
								<th class="smf">名</th>
								<th class="smf">病院名</th>
					...
					<form method="post" action="../2018planning/db_entry/doctor_registration/dr00new.php">
						<button type="submit" class="btn btn-success">新規　医師/コメディカル登録</button>
					</form>
					<button type="submit" class="btn btn-danger" onClick="location.href='../../planner_only/index-mod.php'"><span class="glyphicon glyphicon-fast-backward"></span>Top Pageに戻る</button>
				</div>
			</div>
