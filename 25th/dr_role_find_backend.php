...
foreach ( $rows as $row ) {
	...
	$search_results .= '<form method="post" action="each_dr_roles_list.php">';
	$search_results .= '<input type="hidden" name="dr_tbl_id" value="' . _Q( $row[ 'id' ] ) . '" id="dr_id" />';
	$search_results .= '<input type="submit" class="back-red_yellow" value="Show My Role! (私のお仕事は)" />';
