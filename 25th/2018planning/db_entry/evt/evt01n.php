...
<body>
	<div class="container">
		<div class="row col-lg-10">
			<h1>EVTセッション入力・修正フォーム
			<button class="btn btn-lg btn-info" onClick="location.href='../../../2018planning/index2018evt_mod-n.php';">戻る</button>
	</h1>
				...
				<div class="col-sm-6">
					<div class="text-left">
						<form method="post" action="evt_chair_mod_add01new.php" class="form-inline text-left">
							<button type="submit" class="btn btn-sm btn-warning" name="session_tbl_id" value="<?= $row['id'] ?>">Chair追加</button>
