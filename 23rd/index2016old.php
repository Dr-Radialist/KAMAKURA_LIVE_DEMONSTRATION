<?php
	...
	$stmt_come = $pdo->prepare("SELECT MAX(`changed`) FROM `comedical_session_tbls`;");
	$stmt_come->execute();
...
<!-- Bootstrap core CSS -->
<link rel="stylesheet" type="text/css" href="program_detail/css/bootstrap.min.css">
...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation"  style="padding-top:5px;">
  <div class="masthead">
    <ul class="nav nav-pills">
      <li class="dropdown"> <a href="#" class="dropdown-toggle white" data-toggle="dropdown">鎌倉LIVE2016<b class="caret"></b></a>
        <ul class="dropdown-menu">
          <li><a href="#pci1">TRIライブ一日目</a></li>
          <li><a href="#pci2">TRIライブ二日目</a></li>
          <li><a href="db_read/evt_session_all_read.php">SFA-EVTビデオライブ</a></li>
          <li><a href="db_read/come_session_all_read.php">コメディカル・セッション</a></li>
      ...
      <li class="navbar-brand">
          <li><a href="#">鎌倉ライブデモンストレーション</a></li>
        </ul>
      </li>
    </ul>
  </div>
...
<div class="container"> 
  ...
  <div class="row">
    ...
    <div style="height: 140px;">
     ...
     <form name="session_id" method="post" action="db_read/tri_sessions.php">
      <table id="pci1">
    ...
    <div style="height: 140px;">
      ...
      <form name="session_id" method="post" action="db_read/evt_sessions.php">
      <table id="evt">
      ...
      <div style="height:2em;"><br></div>
      <form name="session_id" method="post" action="db_read/comedical_sessions.php"> 
      <table id="come">
      <tr><td class="tt-timeb" style="height:120px;">7:00 - 8:30</td>
      <td class="tt-header" colspan="2" >12月18日(日)<br>
        YOKOHAMA BAYSIDE WALKING & RUN</td></tr>
  ...
  <hr>
  <footer>
    <p>&copy;  2013 - 2016 by NPO International TRI Network & KAMAKURA LIVE</p><p><a class="btn btn-lg" role="button" href="../24th/index2015.html">&raquo; <br></a> </p>
  </footer>
