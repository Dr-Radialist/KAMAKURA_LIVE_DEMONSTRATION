<?php
	...
	$stmto = $pdo->prepare("SELECT * FROM `evt_session_tbls` WHERE `id` = :id;");
	...
	if ($change_flag) {
		$stmt = $pdo->prepare("UPDATE `evt_session_tbls` SET `begin` = :begin, 
	...
	header('Location:../../index2016evt_mod.php');
?>
