...
<link rel="stylesheet" type="text/css" href="../../../db_read/tri_session_table.css">
        <script>
			var sessionNo = "<?= _Q($_POST['sessionNo']) ?>";
			var role_kind = "<?= _Q($_POST['role_kind']) ?>";
		</script>
</head>

<body>
<h3 class="text-center text-danger">役割割付表
...
<div class="row col-md-12 text-center">
  <div class="col-md-12">
    <div class="form-group">
      <form id="searchform" method="post">
        <label for="search_term">候補者の姓をアルファベットで入力して下さい</label>
        <input type="text" class="form-control" id="search_term" name="search_term" placeholder="候補者姓アルファベットを入力して下さい" />
        <button></button>
  ...
  <div class="col-sm-12">
<p><a class="btn btn-danger" id="return" href="../../index2016come_mod-m.php">該当する候補者はありません</a></p>
  </div>
</div>
...
<script>
	$(document).ready(function() {
		...
		function ajax_search() {		
			...
			$.post("dr_role_find_backend.php", {search_term: search_val, sessionNo: sessionNo, role_kind: role_kind}, function(data) {
				if (data.length > 0) {
