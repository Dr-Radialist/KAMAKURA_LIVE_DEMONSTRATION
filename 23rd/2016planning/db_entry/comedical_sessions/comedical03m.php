...
<div class="container">
  ...
  <div class="container">
    ...
    <div class="row">
      <form name="tri" method="post" action="comedical04m.php">
        <div class="col-lg-12">
          <h3>セッション番号:
          ...
          <h4>座長:
            <?=  _Q(makeComeList($pdo, $_SESSION['sessionNo'], 1)) ?>
          </h4>
          <?php 
		 ...
		 ?>
        <h4>モデレーター: 
        		<?= _Q(makeComeList($pdo, $_SESSION['sessionNo'], 2)) ?>
         </h4>
          <?php
		...
		?>
        <h4>演者:
        		<?= _Q(makeComeList($pdo, $_SESSION['sessionNo'], 3)) ?>
        </h4>
        <h5>カテ室画像診断者:
        		<?= _Q(makeComeList($pdo, $_SESSION['sessionNo'], 4)) ?>
         </h5>
      ...
      <form method="post" action="comedical01m.php">
