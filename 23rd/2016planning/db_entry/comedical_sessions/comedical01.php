<?php
	...
	$stmt = $pdo->prepare("SELECT *FROM `session_tbls` WHERE `sessionNo` = :sessionNo;");
	$stmt->bindValue(":sessionNo", $_POST['sessionNo'], PDO::PARAM_INT);
	$stmt->execute();
	if ($stmt->rowCount() ==0) {	// 新規登録
		$stmt1 = $pdo->prepare("INSERT INTO `session_tbls` (`sessionNo`) VALUES (:sessionNo);");
...
<div class="container">
  <div class=" col-lg-10">
    ...
    <div class="row">
      <form name="come" method="post" action="comedical02.php">
