...
<div class="container">
  ...
  <div class="container">
    ...
    <div class="row">
      <form name="tri" method="post" action="tri04.php">
        <div class="col-lg-12">
          <h3>セッション番号:
		 ...
		 ?>
          <?php
		 	if ($_SESSION['moderator'] != '') {
				echo "<h4>モデレーター: "._Q($_SESSION['moderator'])."</h4>";
			}
		?>
          <?php
		...
		?>
          <?php
			if ($_SESSION['speaker'] != '') {
        			echo "<h5>演者: "._Q($_SESSION['speaker'])."</h5>";
			}
		?>
          <?php
			if ($_SESSION['interpreter'] != '') {
        			echo "<h5>カテ室画像診断者: "._Q($_SESSION['interpreter'])."</h5>";
			}
		?>
          <?php
			if ($_SESSION['venue'] != '') {
      ...
      <form method="post" action="tri01.php">
