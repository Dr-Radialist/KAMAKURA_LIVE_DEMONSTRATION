<?php
	...
	$stmt = $pdo->prepare("SELECT * FROM `session_tbls` WHERE `class` = 'evt' AND `sessionNo` >= '0' ORDER BY `id` ASC;");
	$flag = $stmt->execute();
...
<div class="container">
  <h2 class="text-center text-danger">EVT Session 12/17 (SAT)</h2>
  <div class="row">
    <div  class="session">
      <div class="col-lg-11">
        <div  class="col-lg-10 session_sub">
          <form method="post" action="db_entry/evt/evt01m.php">
