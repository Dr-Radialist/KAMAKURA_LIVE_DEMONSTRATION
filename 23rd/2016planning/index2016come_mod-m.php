...
<div class="container">
  <h1 class="text-center text-danger">Co-Medical Session 12/18 (SUN)</h1>
  <div class="row">
    <div  class="session">
      <div class="col-lg-11">
        <div  class="col-lg-10 session_sub">
          <form method="post" action="db_entry/comedical_sessions/comedical01m.php">
            ...
            <div class="fclear" id="chair1">座長:
              <?= makeComeList($pdo, 1, 1); ?>
            </div>
