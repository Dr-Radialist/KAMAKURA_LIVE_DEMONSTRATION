<?php
	...
	if ($stmt->rowCount() ==0) {	// 新規登録
		$stmt1 = $pdo->prepare("INSERT INTO `comedical_session_tbls` (`sessionNo`) VALUES (:sessionNo);");
...
<h1>Co-medicaセッション入力・修正フォーム</h1>
  <div class="row">
  <form name="tri" method="post" action=comedical02.php">
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" name="sessionContent" rows="4" required
    placeholder="セッションの内容について記載してください"><?= $row['sessionContent']; ?></textarea>
  </div>
  <div class="form-group">
