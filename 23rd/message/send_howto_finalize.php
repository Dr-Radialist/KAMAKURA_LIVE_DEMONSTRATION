...
Dear Dr/Mr/Mrs {$firstname} {$sirname} ({$hp_name})

Thank you for your kind effort in RAP and BEAT Clinical Trial.
You need to finalize the data of the following patients:
{$list_non_finalized}

We sent the document how to do finalize the cases.
...
--1000000000
Content-Type: application/pdf; name="How_to_finalize.pdf"
