...
<body>
<h3 class="text-center text-danger">Role Finding for Active Participants
  ...
  <div class="col-md-11">
    <div class="form-group">
      <form id="searchform" method="post">
        <label for="search_term">Your Sirname in Alphabets</label>
        <input type="text" class="form-control" id="search_term" name="search_term" placeholder="You put your sirname in alphabets to find your roles!" />
        <button></button>
...
<script>
	$(document).ready(function() {
		...
		function ajax_search() {		
			...
			$.post("dr_role_find_backend.php", {search_term: search_val}, function(data) {
				if (data.length > 0) {
