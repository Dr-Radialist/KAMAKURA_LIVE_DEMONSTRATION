<!-- 
これが 2016年に実際に使用されたもののから少しのみ変更したもののコピーである
-->
...
<head>
	...
	<link rel="stylesheet" href="../24th/css/2017top_main.css">
</head>
...
<body>
		...
		<div class="navbar navbar-inverse navbar-fixed-bottom" role="navigation">
			<div class="masthead">
				<ul class="nav nav-pills">
					<li class="dropdown"> <a href="#" class="dropdown-toggle li-white" data-toggle="dropdown"><span class="glyphicon glyphicon-calendar navigation_icon"></span><b class="caret"></b></a>
						<ul class="dropdown-menu">
							<li><a href="db_read/tri_session_all_read.php">TRIライブ一日目</a>
							</li>
							<li><a href="db_read/tri_session_all_read.php#day2">TRIライブ二日目</a>
							</li>
							<li><a href="db_read/evt_session_all_read.php">SFA-EVTビデオライブ</a>
							</li>
							<li><a href="db_read/come_session_all_read.php">コメディカル・セッション</a>
							</li>
							<li class="divider"></li>
							<li class="dropdown-header red bold">Detail</li>
							<li><a href="2016planning/introduction2016.html">Introduction</a>
							</li>
							<li><a href="dr_role_find.php">Find your role <i class="glyphicon glyphicon-search"></i></a>
							</li>
							<li><a href="comecome2016/2016comecome.pdf">コメコメ演題募集</a>
							</li>
							<li><a class="btn btn-primary" role="button" id="openProgram">このページ</a>
							</li>
						</ul>
					</li>
					<li class="dropdown"> <a href="#" class="dropdown-toggle li-white" data-toggle="dropdown"><span class="glyphicon glyphicon-home navigation_icon"><i class="glyphicon glyphicon-exclamation-sign"></i></span></a>
						<ul class="dropdown-menu">
							<li><a href="dr_registration.php?member_kind=4">日本国内招聘Faculty</a>
							</li>
							<li><a href="dr_registration.php?member_kind=3">Foreign Invited Faculty</a>
							</li>
							<li><a href="dr_registration.php?member_kind=6">Sd Faculty</a>
							</li>
							<li><a href="dr_registration.php?member_kind=5">親善参加</a>
							</li>
							<li><a href="dr_registration.php?member_kind=1">NPO社員</a>
							</li>
						</ul>
					</li>
					<li class="dropdown"><a href="#" class="dropdown-toggle li-white" data-toggle="dropdown"><span style="color:yellow;"><i class="glyphicon glyphicon-alert"></i></span></a>
						<ul class="dropdown-menu">
							<li><a href="administration/tri_roles_overview1.php">TRI Session-1 Overview</a>
							</li>
							<li><a href="administration/tri_roles_overview2.php">TRI Session-2 Overview</a>
							</li>
							<li><a href="administration/evt_roles_overview.php">EVT Session Overview</a>
							</li>
							<li><a href="administration/comedical_roles_overview.php">Comedical Session Overview</a>
							</li>
						</ul>
					</li>
					<li class="dropdown"> <a href="#" class="dropdown-toggle li-white" data-toggle="dropdown"><img src="Logo/2016reverse.jpg" width="35" height="30" alt=""/></a>
	...
	<div class="container">
      ...
      <?= $latest ?>
			...
			<h4 class="title">鎌倉ライブ2017 <a class="btn btn-primary btn-sm eng" role="button">English</a> CVIT専門医認定医更新点数2点</h4>
			<div class="row">
				<div class="col-lg-12"> <a class="btn btn-success" role="button" href="db_read/tri_session_all_read.php ">TRIライブ(17日)</a> <a class="btn btn-danger" role="button" href="db_read/evt_session_all_read.php">EVTビデオ(17日)</a> <a class="btn btn-primary" role="button" href="2016FinalPDFProgram/2016Party.pdf">Welcome Party</a> <a class="btn btn-warning" role="button" href="db_read/tri_session_all_read.php#day2">TRIライブ(18日)</a> <a class="btn btn-info" role="button" href="db_read/come_session_all_read.php">コメコメ(18日)</a> </div>
				<div class="col-lg-10 back-sky-blue">
					...
					<p><img src="Logo/Saito_hat.png" width="84" height="71" class="right_float"/>
					</p>
					<ol>
						<li>TRIセッション　<a class="btn btn-danger" role="button" href="2016Company_Posters/2016LuncheonAbbott_6.pdf">Abbott</a>　<a class="btn btn-success" role="button" href="2016Company_Posters/2016_LuncheonTerumo_3.pdf">TERUMO</a>　<a class="btn btn-warning" role="button" href="2016Company_Posters/2016_MiniLectureVOLCANO_4.pdf">Philips/Volcano</a></li>
						<li>EVTセッション　<a class="btn btn-info" role="button" href="2016Company_Posters/2016_Cordis_EVT_LuncheonCardinal Health Japan_5.pdf">Cordis</a>　<a class="btn btn-primary" role="button" href="2016Company_Posters/2016_Boston_EVT_Luncheon.pdf">Boston Scienfific</a>
						</li>
						<li>コメディカル・セッション <a class="btn btn-danger" role="button" href="2016Company_Posters/2016Comedical_Luncheon.pdf">第一三共</a>　</li>
					</ol>
				...
				<div class="col-sm-12"> <a class="btn btn-info" role="button" href="https://conv.toptour.co.jp/shop/evt/KAMAKURA_LIVE/">事前登録(お得です!)</a> <a class="btn btn-primary" role="button" href="dr_role_find-J.php">お仕事 <i class="glyphicon glyphicon-search"></i></a> <a class="btn btn-success openMidokoro" role="button">今年の見どころ　見てね! &raquo;</a> <a class="btn btn-danger" role="button" href="2016FinalPDFProgram/2016FinalProgram.pdf">最終プログラムPDF</a> </div>
			</div>
		</div>
      ...
      <?= $latest ?>
			...
			<div class="row">
				<div class="col-lg-12"> <a class="btn btn-success" role="button" href="db_read/tri_session_all_read.php ">TRI Live (17<sup>th</sup>)</a> <a class="btn btn-danger" role="button" href="db_read/evt_session_all_read.php">EVT Video (17<sup>th</sup>)</a> <a class="btn btn-primary" role="button" href="2016FinalPDFProgram/2016Party.pdf">Welcome Party</a> <a class="btn btn-warning" role="button" href="db_read/tri_session_all_read.php#day2">TRI Live (18<sup>th</sup>)</a> <a class="btn btn-info" role="button" href="db_read/come_session_all_read.php">ComeCome (18<sup>th</sup>)</a> </div>
				<div class="col-lg-10 back-faint-pink">
					...
					<ol>
						...
						<li>EVT Session　<a class="btn btn-info" role="button" href="2016Company_Posters/2016_Cordis_EVT_LuncheonCardinal Health Japan_5.pdf">Cordis</a>　<a class="btn btn-primary" role="button" href="2016Company_Posters/2016_Boston_EVT_Luncheon.pdf">Boston Scienfific</a>
						</li>
						<li>Comedical Session <a class="btn btn-danger" role="button" href="2016Company_Posters/2016Comedical_Luncheon.pdf">Daiichi Sankyo</a>　</li>
					</ol>
				...
				<div class="col-sm-12"> <a class="btn btn-info" role="button" href="https://conv.toptour.co.jp/shop/evt/KAMAKURA_LIVE/">Discounted Preregistration</a> <a class="btn btn-primary" role="button" href="dr_role_find-J.php">Find Your Role <i class="glyphicon glyphicon-search"></i></a> <a class="btn btn-success openProgramE" role="button">Attention! What' interesting &raquo;</a> <a class="btn btn-danger" role="button" href="2016FinalPDFProgram/2016FinalProgram.pdf">Final Program PDF</a>　</div>
			</div>
		</div>
		<footer>
