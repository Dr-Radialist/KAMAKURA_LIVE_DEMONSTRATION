<?php
	...
	$i = 0;
	while ($i < 60) {		//dummyのセッションを60まで作成してしまう
		$stmt_sessionNo2 = $pdo->prepare("INSERT INTO `tri_session_tbls` (`sessionNo`) VALUES (:sessionNo);");
		$stmt_sessionNo2->bindValue(":sessionNo", $i, PDO::PARAM_INT);
		$stmt_sessionNo2->execute();
		$i++;
	}
    ...
    <ul class="nav nav-pills">
      <li class="dropdown"> <a href="#" class="dropdown-toggle white" data-toggle="dropdown">LIVE2016<b class="caret"></b></a>
        <ul class="dropdown-menu">
          ...
          <li><a href="../dr_registration.phpl">Faculty</a></li>
          <li><a href="#" id="">???</a></li>
        </ul>
      </li>
