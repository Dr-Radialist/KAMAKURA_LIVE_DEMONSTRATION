...
<div class="container">
  <div class=" col-lg-10">
    ...
    <div class="row form-inline">
      <form name="come" method="post" action="tri02m.php">
    ...
    <div class="row form-group form-inline">
      <div class="col-sm-6">
        <div class="text-left">
          <form method="post" action="chair_mod_add01m.php" class="form-inline text-left";>
      ...
      <div class="col-sm-6">
        <div class="text-right">
          <form method="post" action="chair_mod_add01m.php" class="form-inline text-right";>
            <button type="submit" class="btn btn-sm" name="session_tbl_id" value="<?= $row['id'] ?>">Moderator追加</button>
            <input type="hidden" name="role_kind" value="2" />
            <input type="hidden" name="sessionNo" value="<?= _Q($row['sessionNo']); ?>" />
          </form>
          <div class="text-right">Moderator:
            <?= $moderator_list ?>
          </div>
        </div>
        <div class="text-right">
