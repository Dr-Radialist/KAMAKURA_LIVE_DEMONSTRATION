...
`role_tbls`.`dr_tbl_id` WHERE `role_tbls`.`year` = '2019' ORDER BY `doctor_tbls`.`english_sirname` ASC, 
`doctor_tbls`.`member_kind` ASC;";
...
<head>
	...
	<title>KAMAKURA LIVE 2019 Faculty List</title>
	<!-- Bootstrap core CSS -->
...
<body>
	<div class="container">
		<div class="row col-sm-12 text-center">
			<h1 class="text-center text-danger">2019 Faculty List</h1>
