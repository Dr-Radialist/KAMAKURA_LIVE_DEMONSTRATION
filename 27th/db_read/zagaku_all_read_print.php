...
$class = 'zagaku';
$stmt = $pdo->prepare( "SELECT * FROM `session_tbls2019` WHERE `class` = '" . $class . "' AND `year` = '" . $this_year . "' ORDER BY `begin` ASC;" );
		...
		<div class="row">
			...
			<div class="panel-group border-thick">
				...
				<div class="panel-body">
					<ul class="list-inline">
						<?php
						if ( makeCommonSessionListTRIJ2print( $pdo, $sessionNo, 1, $class, $this_year ) != "" ) {
							echo "<li><span>&nbsp;Chair:&nbsp;</span>";
							echo makeCommonSessionListTRIJ2print( $pdo, $sessionNo, 1, $class, $this_year );
							echo "</li>";
						}
						if ( makeCommonSessionListTRIJ2print( $pdo, $sessionNo, 3, $class, $this_year ) != "" ) {
							echo "<li><span>Speaker:&nbsp;</span>";
							echo makeCommonSessionListTRIJ2print( $pdo, $sessionNo, 3, $class, $this_year );
							echo "</li>";
						}
						if ( makeCommonSessionListTRIJ2print( $pdo, $sessionNo, 2, $class, $this_year ) != "" ) {
							echo "<li><span>Discussants:&nbsp;</span>";
							echo makeCommonSessionListTRIJ2print( $pdo, $sessionNo, 2, $class, $this_year );
							echo "</li>";
						}
						if ( makeCommonSessionListTRIJ2print( $pdo, $sessionNo, 4, $class, $this_year) != "" ) {
							echo "<li><span>In-Cathlabo Commentators:&nbsp;</span>";
							echo makeCommonSessionListTRIJ2print( $pdo, $sessionNo, 4, $class, $this_year);
							echo "</li>";
						}
						?>
					</ul>
