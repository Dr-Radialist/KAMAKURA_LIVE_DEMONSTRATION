...
$class = 'zagaku';
//$this_year = '2019';
$stmt = $pdo->prepare( "SELECT * FROM `session_tbls2019` WHERE `class` = 'zagaku' AND `year` = '".$this_year."' ORDER BY `begin` ASC;" );
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<ul class="list-inline">
						<li class="text-center text-warning bold28">&nbsp;&nbsp;KODOCU（蠱毒）12/14 (SAT) @ 日石ホール
						</li>
                        <li class="text-success">Kamakura supreme selection of Interventional Devices for young operators and co-medical stuff.　KODOCU（蠱毒）- 若手医師とコメディカルが最高のデバイスを使用して手技を行えるように、各社デバイスの良い所をご紹介します。
                        </li>
						<li class="text-danger bold20">最終更新日時:
							<?= $latest ?>
						</li>
					</ul>
				</div>
