...
<style>
#back {
    background: linear-gradient(to bottom, rgb(30, 30, 200), rgb(225, 80, 80));
}
...
<div class="container">
  <div class="row">
    <div class="col-lg-11">
      ...
      <img src="../Logo/face2018-BW.png" width="85" height="85" style="float:right;"/>
      <div style="width: 80%;margin-left: auto; margin-right: auto; background:radial-gradient(rgba(255,255,255,1), rgba(0, 0, 0, 0));padding-bottom:1em;">
        ...
        <h1 style="text-align: center; font-weight:bold; color:#B55303;">コメディカル・セッション 12/15 (SUN)</h1>
      </div>
      ...
      <div class="panel panel-default" style="border-right:#444 solid 0.5em; border-bottom:#444 solid 0.5em;border-radius:2em 2em 0 0;">
        <div class="panel-heading" style="background-color: rgba(70,164,221,1.00); border-radius:2em 2em 0 0;">
          <h2 class="white"><strong><span class="white" style="font-size: 0.6em;background-color: rgba(70,164,221,1.00); font-weight:bold;padding: 0.3em;">
        ...
        <div class="panel-body">
          <h3 style="color: rgba(70,164,221,1.00)"> <strong>
      ...
      <div class="panel panel-default" style="border-right:#444 solid 0.5em; border-bottom: #444 solid 0.5em;border-radius:2em 2em 0 0;">
        <div class="panel-heading" style="background-color: rgba(212,45,38,1.00); border-radius:2em 2em 0 0;">
          <h2 class="white"><strong><span class="white" style="font-size: 0.6em;background-color: rgba(212,45,38,1.00); ">
            <?= _Q(mb_substr($rows[$sessionNo]['begin'], 0, 5)); ?>
            &nbsp;-&nbsp;
            <?= date("H:i" , strtotime($rows[$sessionNo]['begin']) +$rows[$sessionNo]['duration']*60); ?>
            </span>&nbsp;
        ...
        <div class="panel-body">
          <h3 style="color: rgba(212,45,38,1.00);"> <strong>
            <?=_Q($rows[$sessionNo]['lectureTitle']); ?>
            </strong></h3>
        </div>
        <div class="panel-footer" style="line-height: 1.2em;">
      ...
      <div class="panel panel-default" style="border-right:#444 solid 0.5em; border-bottom: #444 solid 0.5em;border-radius: 2em 2em 0 0;">
        <div class="panel-heading" style="background-color: rgba(154,192,67,1.00); border-radius:2em 2em 0 0;">
          <h2 class="white"><strong><span class="white" style="font-size: 0.6em;background-color: rgba(154,192,67,1.00); ">
            <?= _Q(mb_substr($rows[$sessionNo]['begin'], 0, 5)); ?>
            &nbsp;-&nbsp;
            <?= date("H:i" , strtotime($rows[$sessionNo]['begin']) +$rows[$sessionNo]['duration']*60); ?>
            </span>&nbsp;
        ...
        <div class="panel-body">
          <h3 style="color: rgba(154,192,67,1.00);"> <strong>
            <?=_Q($rows[$sessionNo]['lectureTitle']); ?>
            </strong></h3>
        </div>
        <div class="panel-footer" style="line-height: 1.2em;">
      ...
      <div class="panel panel-default" style="border-right:#444 solid 0.5em; border-bottom: #444 solid 0.5em;border-radius: 2em 2em 0 0;">
        <div class="panel-heading" style="background-color: rgba(68,154,134,1.00);border-radius:2em 2em 0 0;">
          <h2 class="white"><strong><span class="white" style="font-size: 0.6em;background-color: rgba(68,154,134,1.00); ">
            <?= _Q(mb_substr($rows[$sessionNo]['begin'], 0, 5)); ?>
            &nbsp;-&nbsp;
            <?= date("H:i" , strtotime($rows[$sessionNo]['begin']) +$rows[$sessionNo]['duration']*60); ?>
            </span>&nbsp;
        ...
        <div class="panel-body">
          <h3 style="color: rgba(68,154,134,1.00);"> <strong>
            <?=_Q($rows[$sessionNo]['lectureTitle']); ?>
            </strong></h3>
        </div>
        <div class="panel-footer" style="line-height: 1.2em;">
      ...
      <div class="panel panel-default" style="border-right:#444 solid 0.5em; border-bottom: #444 solid 0.5em;border-radius: 2em 2em 0 0;">
        <div class="panel-heading" style="background-color: rgba(183, 40, 102,1.00); border-radius:2em 2em 0 0;">
          <h2 class="white"><strong><span class="white" style="font-size: 0.6em;background-color: rgba(183, 40, 102,1.00); ">
            <?= _Q(mb_substr($rows[$sessionNo]['begin'], 0, 5)); ?>
            &nbsp;-&nbsp;
            <?= date("H:i" , strtotime($rows[$sessionNo]['begin']) +$rows[$sessionNo]['duration']*60); ?>
            </span>&nbsp;
        ...
        <div class="panel-body">
          <h3 style="color: rgba(183, 40, 102,1.00);"> <strong>
            <?=_Q($rows[$sessionNo]['lectureTitle']); ?>
            </strong></h3>
        </div>
        <div class="panel-footer" style="line-height: 1.2em;">
  ...
  <hr>
  <footer>
    <p class="white"><strong>&copy; 2013 - 2019 by NPO International TRI Network & KAMAKURA LIVE</strong></p>
  </footer>
</div>
