...
$stmt = $pdo->prepare( "UPDATE `session_tbls2018` SET `sessionNo` = :sessionNo, `beginDate` = :beginDate, `duration` = :duration, `sessionTitle` =:sessionTitle, `cosponsor` =:cosponsor, `lectureTitle` = :lectureTitle, `day` = :day, `venue` =:venue, `changed` =:changed, `year` = :year, `begin` =:begin, `class` = :class, `begin` = :begin, `description` =:description WHERE `id` = :id;" );
