<?php
	...
	$stmt_come = $pdo->prepare("SELECT MAX(`changed`) FROM `session_tbls2019`;");
	$stmt_come->execute();
...
<div class="container"> 
  ...
  <div class="row">
    ...
    <div style="height: 140px;">
     ...
     <form name="session_id" method="post" action="../2017planning/db_entry/tri/tri01.php"> 
      <table id="pci1">
    ...
    <div style="height: 140px;">
      ...
      <form name="session_id" method="post" action="../2017planning/db_entry/evt/evt01.php">
      <table id="evt">
      ...
      <div style="height:2em;"><br></div>
      <form name="session_id" method="post" action="../2017planning/db_entry/comedical_sessions/comedical01.php"> 
      <table id="come">
      <tr><td class="tt-timeb" style="height:120px;">7:00 - 8:30</td>
      <td class="tt-header" colspan="2" >12月18日(日)<br>
        YOKOHAMA BAYSIDE WALKING & RUN</td></tr>
   ...
   <span class="small">EVT Session、ランチョン・セミナー</span>、<br><span class="small">イブニング・セミナーのご案内です</span></a> </p>
      ...
      <p><a class="btn btn-p btn-lg 2015komekome" role="button" href="../comecome2017/2016comecome.pdf">コメコメ演題募集中!!　&raquo;</a></p>
      <p><a class="btn btn-re" role="button" href="../comecome2017/2016comecome.pdf">コメコメ皆さんに配布を!!　&raquo;</a></p>
  ...
  <hr>
  <footer>
    <p>&copy;  2013 - 2017 by NPO International TRI Network & KAMAKURA LIVE</p><p><a class="btn btn-p btn-sm" role="button" href="../index2015.html">&raquo; <br></a> </p>
  </footer>
</div>
