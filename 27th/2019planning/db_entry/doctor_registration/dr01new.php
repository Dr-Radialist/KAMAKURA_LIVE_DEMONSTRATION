...
<body>
	<div class="container">
		<div class=" col-lg-10">
			<h1>医師/コメディカル入力・修正フォーム</h1>
			<div class="row">
				<form name="doctor" method="post" action="../../../2019planning/db_entry/doctor_registration/dr02new.php">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" name="email" value="<?= _Q($_POST['email']); ?>" readonly/>
					</div>
					<?php
					} else {
						?>
