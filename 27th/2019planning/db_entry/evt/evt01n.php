...
<body>
	<div class="container">
		<div class="row col-lg-10">
			<h1>座学部門入力・修正フォーム
			  <button class="btn btn-lg btn-info" onClick="location.href='../../../2019planning/index2019evt_mod-n.php';">戻る</button>
	</h1>
			<div class="row form-inline">
				<form name="come" method="post" action="../../../2019planning/db_entry/evt/evt02n.php">
					...
					<div class="form-group">
						...
						<textarea class="form-control" name="description" rows="4" cols="60" placeholder="セッションの内容について記載してください"><?= _Q($row['description']); ?>
</textarea>
					</div>
					<div class="form-group">
			...
			<div class="row form-group form-inline">
				<div class="col-sm-6">
					<div class="text-left">
						<form method="post" action="evt_chair_mod_add01new.php" class="form-inline text-left">
						...
						<div class="text-left">座長:
							<?= $chair_list ?>
						</div>
						<!--<button class="btn btn-sm btn-danger" onClick="location.href='../../../../planner_only/index-mod.php';">戻る</button> -->
						<br><span>-----------------------------------------------</span><br>
					</div>
					<div class="text-left">
						<form method="post" action="evt_chair_mod_add01new.php" class="form-inline text-left">
							<button type="submit" class="btn btn-lg btn-success" name="session_tbl_id" value="<?= $row['id'] ?>">コメンテーター追加</button>
							<input type="hidden" name="role_kind" value="3"/>
							<input type="hidden" name="sessionNo" value="<?= _Q($row['sessionNo']); ?>"/>
						</form>
						<div class="text-left">コメンテーター:
							<?= $lecturer_list ?>
						</div>
						<!-- <button class="btn btn-sm btn-danger" onClick="location.href='../../../../planner_only/index-mod.php';">戻る</button> -->
						<br><span>-----------------------------------------------</span><br>
				...
				<div class="col-sm-6">
					<div class="text-right">
						<form method="post" action="evt_chair_mod_add01new.php" class="form-inline text-right">
							<button type="submit" class="btn btn-lg btn-warning" name="session_tbl_id" value="<?= $row['id'] ?>">Speaker追加</button>
							<input type="hidden" name="role_kind" value="2"/>
							<input type="hidden" name="sessionNo" value="<?= _Q($row['sessionNo']); ?>"/>
						</form>
						<div class="text-right">Speaker:
							<?= $moderator_list ?>
						</div>
						<!--<button class="btn btn-sm btn-danger" onClick="location.href='../../../../planner_only/index-mod.php';">戻る</button> -->
						<br><span>-----------------------------------------------</span><br>
					...
					<div class="text-right">
						<form method="post" action="evt_chair_mod_add01new.php" class="form-inline text-right">
							<button type="submit" class="btn btn-lg btn-success" name="session_tbl_id" value="<?= $row['id'] ?>">カテ室画像診断追加</button>
							<input type="hidden" name="role_kind" value="3"/>
							<input type="hidden" name="sessionNo" value="<?= _Q($row['sessionNo']); ?>"/>
						</form>
