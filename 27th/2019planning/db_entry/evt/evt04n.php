<?php
	...
	$stmto = $pdo->prepare("SELECT * FROM `session_tbls2019` WHERE `id` = :id AND `class` = :class AND `year` = :year;");
	...
	if ($change_flag) {
		// ここから2019年度改良
		$beginDate = '2019-12-14 '.$_POST['begin'];
		//echo $beginDate; exit;
		//
		$stmt = $pdo->prepare("UPDATE `session_tbls2019` SET `begin` = :begin, 
	...
	header('Location:../../index2019evt_mod-n.php');
?>
