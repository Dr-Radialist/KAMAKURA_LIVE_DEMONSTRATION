...
<div class="container">
  ...
  <div class="container">
    ...
    <div class="row">
      <form name="tri" method="post" action="../../../2019planning/db_entry/evt/evt04n.php">
         <div class="col-lg-12">
          <h3>セッション番号:
          ...
          <h4>座長:
            <?=  _Q(makeCommonSessionList($pdo, $_SESSION['sessionNo'], 1, $class, $this_year)) ?>
          </h4>
          <?php 
		 ...
		 ?>
        <h4>モデレーター: 
        		<?= _Q(makeCommonSessionList($pdo, $_SESSION['sessionNo'], 2, $class, $this_year)) ?>
         </h4>
          <?php
		...
		?>
        <h4>演者:
        		<?= _Q(makeCommonSessionList($pdo, $_SESSION['sessionNo'], 3, $class, $this_year)) ?>
        </h4>
        <h5>カテ室画像診断者:
        		<?= _Q(makeCommonSessionList($pdo, $_SESSION['sessionNo'], 4, $class, $this_year)) ?>
         </h5>
