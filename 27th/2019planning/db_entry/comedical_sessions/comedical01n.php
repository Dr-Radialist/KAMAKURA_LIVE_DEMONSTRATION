	...
	<div class="container">
		<div class=" col-lg-10">
			...
			<div class="row form-inline">
				<form name="come" method="post" action="../comedical_sessions/comedical02n.php">
					...
					<div class="form-group">
						...
						<textarea class="form-control" name="description" rows="8" cols="60" placeholder="セッションの内容について記載してください"><?= _Q($row['description']); ?></textarea>
					</div>
					<div class="form-group">
			...
			<div class="row form-group form-inline">
				<div class="col-sm-6">
					<div class="text-left">
						<form method="post" action="come_chair_mod_add01new.php" class="form-inline text-left">
							<button type="submit" class="btn btn-lg btn-primary" name="session_tbl_id" value="<?= $row['id'] ?>">Chair追加</button>
					...
					<div class="text-left">
						<form method="post" action="come_chair_mod_add01new.php" class="form-inline text-left">
							<button type="submit" class="btn btn-lg btn-success" name="session_tbl_id" value="<?= $row['id'] ?>">講師追加</button>
				...
				<div class="col-sm-6">
					<div class="text-right">
						<form method="post" action="come_chair_mod_add01new.php" class="form-inline text-right">
							<button type="submit" class="btn btn-lg btn-warning" name="session_tbl_id" value="<?= $row['id'] ?>">Discussant追加</button>
							<input type="hidden" name="role_kind" value="2"/>
							<input type="hidden" name="sessionNo" value="<?= _Q($row['sessionNo']); ?>"/>
						</form>
						<div class="text-right">Discussant:
							<?= $moderator_list ?>
						</div>
						<button class="btn btn-sm btn-danger" onClick="location.href='../../../../planner_only/index-mod.php';">戻る</button>
						<br><span>-----------------------------------------------</span><br>
